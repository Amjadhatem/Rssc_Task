...
<section class="Breif_container">
  ...
  <h2>Partners will develop solutions for each identified barrier:</h2>
  <p>capacity building programme (for lack of skills); innovation desk (for lack of information); guidelines (for lack of regulation); voucher (for lack of finance) and targeted B2B events (for lack of specific matchmaking). The main final beneficiaries are SMEs (especially from environment/utility/building sector) that can have a set of supporting instruments to overcome the existing barriers and reduce the risks to innovation.</p>
    </div>
    <h4><a style="text-decoration: none; " href="https://www.enicbcmed.eu/projects/maia-taqa">Project Website <i class="fa-solid fa-arrow-right"></i></a></h4>
</section>
